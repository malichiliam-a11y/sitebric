...
(function () {
  ...
  document.addEventListener('click', function (e) {
    ...
    // EVERY in-page link is handled here, not just the four page ids.
    // Anything left to the browser navigates against the parent's base
    // URL inside a preview frame, which is what put the dashboard in the
    // preview window. A nav that lists more entries than there are pages
