...
export const PLAN_LIMITS = {
  none: { sites: 0, generations: 0, searches: 0, customDomains: false, label: "No plan" },
  trial: { sites: 2, generations: 2, searches: 2, customDomains: false, label: "Free Trial" },
  starter: { sites: 5, generations: 10, searches: 20, customDomains: false, label: "Starter" },
  growth: { sites: 20, generations: 40, searches: 50, customDomains: true, label: "Growth" },
  pro: { sites: 100, generations: 150, searches: 150, customDomains: true, label: "Pro" },
};
