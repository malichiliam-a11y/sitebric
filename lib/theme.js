...
// Type scale. The negative tracking here was drawn for Inter, which sets
// loose; Fraunces sets tighter and needs less of it, so the large sizes
// pull in about a third as far as they used to.
export const type = {
  display: { fontSize: 56, fontWeight: 600, letterSpacing: "-0.015em", lineHeight: 1.05 },
  title: { fontSize: 40, fontWeight: 600, letterSpacing: "-0.012em", lineHeight: 1.12 },
  heading: { fontSize: 21, fontWeight: 600, letterSpacing: "-0.005em", lineHeight: 1.3 },
