...
- Default to a dark, near-black base (not pure #000 — a deep charcoal/navy/graphite reads more premium) with one or two saturated neon/glow accent colors (electric blue, cyan, violet, magenta, acid green — pick what fits the brand) used for highlights, glows, and CTAs against it. Avoid muted pastel or earthy/wood-tone palettes — they read as traditional, not futuristic. A light-mode site is fine only if the brief specifically calls for it; default to dark.
- Favor futuristic visual motifs: glassmorphism (translucent frosted-glass cards with backdrop-filter blur and a thin glowing 1px border), gradient meshes and drifting glow orbs, subtle grid/circuit-line/scanline background textures, holographic or iridescent gradient washes on accents, sharp geometric shapes and angular clip-paths rather than soft rounded skeuomorphic ones.
- Use at least two font families (a bold, geometric/technical display font — e.g. something like Space Grotesk, Sora, Orbitron, or similar sans-serif with a tech feel — plus a clean geometric sans body font) via Google Fonts. Avoid traditional serif, script, or classic slab fonts unless the brief explicitly calls for a non-futuristic aesthetic.
