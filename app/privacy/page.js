...
export default function PrivacyPage() {
  ...
  const h2 = { fontSize: 18, fontWeight: 700, marginBottom: 10, fontFamily: "var(--font-body), -apple-system, BlinkMacSystemFont, sans-serif" };
  ...
  return (
    <div style={{ background: "#0A0A10", color: "#F2F0FA", minHeight: "100vh", fontFamily: "var(--font-body), sans-serif" }}>
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "80px 24px 100px" }}>
        <h1 style={{ fontFamily: "var(--font-body), -apple-system, BlinkMacSystemFont, sans-serif", fontSize: 36, fontWeight: 700, marginBottom: 8 }}>
          Privacy Policy
        </h1>
